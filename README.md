...
If you don't use Maven, you can drop [lokalized-1.2.0-SNAPSHOT.jar](https://repo1.maven.org/maven2/com/lokalized/lokalized/1.2.0-SNAPSHOT/lokalized-1.2.0-SNAPSHOT.jar) directly into your project.  No other dependencies are required.
